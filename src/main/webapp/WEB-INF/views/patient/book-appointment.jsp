        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8">
            ...
            <div class="hero-card glass-card soft-shadow rounded-[30px] p-6 sm:p-8 mb-8 fade-up">
                <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-extrabold text-slate-800">Book Appointment</h1>
                        <p class="text-slate-600 mt-3 text-base sm:text-lg">
                            Select an available slot, add your reason and confirm your appointment quickly.
                        </p>
                        ...
                        <div class="flex flex-wrap gap-3 mt-5">
                            ...
                            <span class="mini-chip bg-pink-100 text-pink-700">
                    ...
                    <div class="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-7 py-6 rounded-[26px] shadow-xl min-w-[250px]">
                        <div class="flex items-center justify-between gap-4">
                            <div>
                                <p class="text-sm uppercase tracking-widest text-green-100">Booking Status</p>
                                <p class="text-3xl font-extrabold mt-2">Ready</p>
                                <p class="mt-2 text-green-100">Choose slot and confirm</p>
                            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    ...
                    <div class="glass-card soft-shadow rounded-[30px] p-6">
                        <div class="flex items-start gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-blue-600 font-semibold mt-1">${doctor.specialization}</p>
                                <div class="mt-3">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-3">
                            <div class="info-card">
                                <p class="text-xs uppercase tracking-wider text-slate-500 font-bold">Available Slots</p>
                                <p class="font-bold text-slate-800 mt-2">${slots.size()}</p>
                            </div>

                            <div class="info-card">
                                <p class="text-xs uppercase tracking-wider text-slate-500 font-bold">Appointment Type</p>
                                <p class="font-bold text-slate-800 mt-2">Doctor Consultation</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="xl:col-span-2 fade-up">
                    <div class="glass-card soft-shadow rounded-[30px] p-5 sm:p-7 lg:p-8">
                        <div class="mb-6">
                            <h2 class="text-2xl font-extrabold text-slate-800">Appointment Form</h2>
                            <p class="text-slate-500 mt-1">Choose slot and write your visit reason clearly.</p>
                        </div>

                        <form action="/patient/book-appointment" method="post" class="space-y-6">

                            <input type="hidden" name="doctorId" value="${doctor.id}">

                            <div>
                                <label class="field-label">Select Available Slot</label>
                                <div class="input-shell select-wrap">
                                    <i class="fa-solid fa-clock input-icon"></i>
                                    <select name="slotId" required class="form-control">
                                        <option value="">-- Select Slot --</option>
                                        <c:forEach var="slot" items="${slots}">
                                            <option value="${slot.id}">
                                                ${slot.availableDate} | ${slot.startTime} to ${slot.endTime}
                                            </option>
                                        </c:forEach>
                                    </select>
                            ...
                            <div>
                                ...
                                <div class="input-shell textarea-wrap">
                                    <i class="fa-solid fa-notes-medical input-icon textarea-icon"></i>
                                    <textarea name="reason"
                                              required
                                              rows="5"
                                              class="form-control textarea-control"
                                              placeholder="Write your reason for appointment"></textarea>
                                </div>
                            </div>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <div class="rounded-2xl bg-amber-50 border border-amber-200 text-amber-700 px-5 py-4">
                                        <div class="flex items-start gap-3">
                                            <i class="fa-solid fa-triangle-exclamation text-lg mt-0.5"></i>
                                            <div>
                                                <p class="font-bold">No slots available</p>
                                                <p class="mt-1">This doctor currently has no available slots. Please go back and choose another doctor or try later.</p>
                                            </div>
                                        </div>
                                    </div>
