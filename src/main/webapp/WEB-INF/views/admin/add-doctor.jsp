        ...
        <main class="flex-1 p-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div>
                        ...
                        <p class="text-slate-600 mt-3 text-lg">
                            Create doctor account with specialization, qualification, consultation fee and city details.
                        </p>

                    </div>

                    <a href="/admin/specializations"
                       class="shine-btn action-btn inline-flex items-center gap-3 bg-gradient-to-r from-amber-400 to-orange-500 text-white px-6 py-4 rounded-[22px] shadow-xl font-semibold">
                        <i class="fa-solid fa-layer-group"></i>
            ...
            <div class="form-card glass-card soft-shadow rounded-[28px] p-8 fade-up">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-7">
                    <div>
                        <h2 class="text-2xl font-extrabold text-slate-800">Doctor Registration Form</h2>
                        <p class="text-slate-500 mt-1">Fill all the required details below.</p>
                    </div>
                ...
                <form action="/admin/add-doctor" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-6">

                    <div class="field-wrap">
                        <label class="field-label">Doctor Name</label>
                        <div class="input-shell">
                            <i class="fa-solid fa-user-doctor input-icon"></i>
                            <input type="text" name="name" required class="form-control" placeholder="Enter doctor full name">
                        </div>
                    </div>
                    ...
                    <div class="field-wrap">
                        ...
                        <div class="input-shell">
                            ...
                            <input type="email" name="email" required class="form-control" placeholder="Enter doctor email">
                        </div>
                    </div>
                    ...
                    <div class="field-wrap">
                        ...
                        <div class="input-shell">
                            ...
                            <select name="specialization" required class="form-control select-control">
                    ...
                    <div class="field-wrap">
                        ...
                        <div class="input-shell">
                            ...
                            <input type="text" name="qualification" required class="form-control" placeholder="MBBS, MD, BDS">
                        </div>
                    </div>
                    ...
                    <div class="field-wrap">
                        ...
                        <div class="input-shell">
                            ...
                            <input type="number" name="experience" required class="form-control" placeholder="Years of experience">
                        </div>
                    </div>
                    ...
                    <div class="field-wrap">
                        ...
                        <div class="input-shell">
                            ...
                            <input type="number" step="0.01" name="consultationFee" required class="form-control" placeholder="500">
                        </div>
                    </div>
                    ...
                    <div class="field-wrap">
                        ...
                        <div class="input-shell">
                            ...
                            <input type="text" name="city" required class="form-control" placeholder="Mumbai">
                        </div>
                    </div>
