        ...
        <main class="flex-1 p-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div>
                        ...
                        <p class="text-slate-600 mt-3 text-lg">
                            Manage active and pending doctors, search records, approve registrations and export data.
                        </p>

                    </div>

                    <div class="flex flex-wrap gap-3">
                        <a href="/admin/export/doctors/csv"
                        ...
                        <a href="/admin/export/doctors/pdf"
            ...
            <div class="table-card glass-card soft-shadow rounded-[28px] p-8 fade-up">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-7">
                    <div>
                        <h2 class="text-2xl font-extrabold text-slate-800">Doctor Management Table</h2>
                        <p class="text-slate-500 mt-1">Search doctors, review status and perform actions quickly.</p>
                    </div>
                ...
                <form method="get" action="/admin/view-doctors" class="mb-6 flex flex-col md:flex-row gap-3">
                    <div class="search-shell flex-1">
                        <i class="fa-solid fa-magnifying-glass search-icon"></i>
                        <input type="text"
                               name="keyword"
                               value="${keyword}"
                               placeholder="Search by doctor name, email, specialization or city"
                               class="search-input">
                    </div>
                    ...
                    <table class="min-w-full border-collapse">
                        <thead>
                            <tr class="bg-slate-100/90">
                                ...
                                <th class="p-4 text-left text-sm font-extrabold text-slate-700">Specialization</th>
                                <th class="p-4 text-left text-sm font-extrabold text-slate-700">City</th>
                                ...
                                <c:when test="${not empty doctors}">
                                    <c:forEach var="doctor" items="${doctors}">
                                        <tr class="table-row border-b border-slate-200/70">
                                            <td class="p-4 text-slate-700 font-semibold">#${doctor.id}</td>
                                            ...
                                            <td class="p-4">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p class="font-bold text-slate-800">${doctor.user.name}</p>
                                                        <p class="text-xs text-slate-500">Doctor Account</p>
                                                    </div>
                                                </div>
                                            </td>

                                            <td class="p-4 text-slate-600">${doctor.user.email}</td>
                                            <td class="p-4 text-slate-700 font-medium">${doctor.specialization}</td>
                                            <td class="p-4 text-slate-600">${doctor.city}</td>

                                            <td class="p-4">
                                                <c:choose>
                                                    <c:when test="${doctor.user.accountStatus == 'PENDING'}">
                                            ...
                                            <td class="p-4">
                                                <div class="flex flex-wrap gap-2">
                                                    <c:if test="${doctor.user.accountStatus == 'PENDING'}">
                                                        <a href="/admin/doctor/approve/${doctor.id}"
                                    ...
                                    <tr>
                                        <td colspan="7" class="p-10">
                                            <div class="text-center">
                                                ...
                                                <h3 class="text-2xl font-extrabold text-slate-800">No Doctors Found</h3>
                                                <p class="text-slate-500 mt-2">No doctor records match your current search.</p>
