        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8">
            ...
            <div class="hero-card glass-card soft-shadow rounded-[30px] p-6 sm:p-8 mb-8 fade-up">
                <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-extrabold text-slate-800">Reschedule Appointment</h1>
                        <p class="text-slate-600 mt-3 text-base sm:text-lg">
                            Choose a new available slot for your existing appointment and confirm the updated timing.
                        </p>
                    ...
                    <div class="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-7 py-6 rounded-[26px] shadow-xl min-w-[250px]">
                        <div class="flex items-center justify-between gap-4">
                            <div>
                                <p class="text-sm uppercase tracking-widest text-amber-100">Reschedule</p>
                                <p class="text-3xl font-extrabold mt-2">Active</p>
                                <p class="mt-2 text-amber-100">Choose new time wisely</p>
                            </div>
                            <i class="fa-solid fa-calendar-plus text-3xl text-white/90"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div class="xl:col-span-1 fade-up">
                    <div class="glass-card soft-shadow rounded-[30px] p-6">
                        <div class="mb-6">
                            <h2 class="text-2xl font-extrabold text-slate-800">Current Appointment</h2>
                            <p class="text-slate-500 mt-1">Review existing details before changing slot.</p>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="info-card">
                                <p class="text-xs uppercase tracking-wider text-slate-500 font-bold">Current Date</p>
                                <p class="font-bold text-slate-800 mt-2">${appointment.appointmentDate}</p>
                            </div>

                            <div class="info-card">
                                <p class="text-xs uppercase tracking-wider text-slate-500 font-bold">Current Time</p>
                ...
                <div class="xl:col-span-2 fade-up">
                    <div class="glass-card soft-shadow rounded-[30px] p-5 sm:p-7 lg:p-8">
                        <div class="mb-6">
                            <h2 class="text-2xl font-extrabold text-slate-800">Choose New Slot</h2>
                            <p class="text-slate-500 mt-1">Pick one available slot and submit to reschedule your appointment.</p>
                        </div>

                        <form action="/patient/reschedule" method="post" class="space-y-6">
                            <input type="hidden" name="appointmentId" value="${appointment.id}">

                            <div>
                                <label class="field-label">Select New Slot</label>
                                ...
                                <c:otherwise>
                                    <div class="rounded-2xl bg-amber-50 border border-amber-200 text-amber-700 px-5 py-4">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p class="font-bold">No new slots available</p>
                                                <p class="mt-1">Currently no alternate slots are available for rescheduling. Please try again later.</p>
                                            </div>
                                        </div>
                                    </div>
