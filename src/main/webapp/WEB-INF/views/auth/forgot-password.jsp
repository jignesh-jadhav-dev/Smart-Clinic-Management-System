...
<head>
    <meta charset="UTF-8">
    <title>Forgot Password - Smart Clinic Management</title>
    ...
    <style>
        ...
        @keyframes pulseGlow {
            0%, 100% {
                box-shadow: 0 0 0 0 rgba(168,85,247,0.22);
            }
            50% {
        ...
        @keyframes borderGlow {
            0%, 100% {
                box-shadow: 0 0 0 0 rgba(168,85,247,0.00);
            }
            50% {
        ...
        .auth-bg {
            background: linear-gradient(-45deg, #ede9fe, #dbeafe, #f5f3ff, #e0f2fe, #f3e8ff);
        ...
        .form-control:hover {
            ...
            background: #ffffff;
            box-shadow: 0 10px 24px rgba(168,85,247,0.10);
        ...
        .form-control:focus {
            border-color: #a855f7;
            background: #ffffff;
            box-shadow: 0 0 0 4px rgba(168,85,247,0.18), 0 14px 30px rgba(168,85,247,0.12);
        }
...
<body class="auth-bg min-h-screen overflow-x-hidden">
    ...
    <div class="fixed top-10 left-8 sm:left-16 w-52 sm:w-64 h-52 sm:h-64 bg-purple-200/40 rounded-full blur-3xl floating-blob pointer-events-none"></div>
    ...
    <div class="fixed top-1/3 right-1/4 w-44 h-44 bg-pink-200/40 rounded-full blur-3xl floating-blob pointer-events-none" style="animation-delay:2s;"></div>
                ...
                <div class="p-6 sm:p-8 lg:p-10 xl:p-12">
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="text-center mb-8 fade-up">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-[24px] bg-gradient-to-r from-purple-500 to-fuchsia-500 flex items-center justify-center shadow-2xl pulse-glow">
                                <i class="fa-solid fa-key text-white text-2xl sm:text-3xl"></i>
                            </div>

                            <h2 class="text-3xl sm:text-4xl font-black text-slate-800 mt-5">Forgot Password</h2>
                            <p class="text-slate-500 mt-3 text-base sm:text-lg">
                                Enter your registered email to generate reset link
                            </p>
                        </div>
                        ...
                        <form action="/forgot-password" method="post" class="space-y-5 fade-up">

                            <div>
                                <label class="block text-slate-700 mb-2 font-semibold">Registered Email</label>
                            ...
                            <button type="submit"
                                    class="shine-btn w-full bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white py-3.5 rounded-2xl hover:scale-[1.02] transition duration-300 shadow-xl font-semibold text-base">
                        ...
                        <% if (request.getAttribute("resetLink") != null) { %>
                            <div class="mt-6 p-4 sm:p-5 bg-blue-50 rounded-2xl border border-blue-200 fade-up">
                                <p class="font-bold text-blue-700 mb-3 flex items-center gap-2">
                                    <i class="fa-solid fa-paperclip"></i>
                                    Reset Link
                                </p>

                                <a href="<%= request.getAttribute("resetLink") %>"
                                   class="text-blue-600 break-all underline word-safe font-medium">
                        ...
                        <div class="mt-6 fade-up">
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div class="light-panel rounded-2xl px-4 py-3 text-center">
                                    <i class="fa-solid fa-key text-purple-600 mb-2"></i>
                                    <p class="text-xs font-bold text-slate-700">Reset Access</p>
                                </div>
                                <div class="light-panel rounded-2xl px-4 py-3 text-center">
                                    <i class="fa-solid fa-shield-halved text-emerald-600 mb-2"></i>
                                    <p class="text-xs font-bold text-slate-700">Secure Flow</p>
                                </div>
                                <div class="light-panel rounded-2xl px-4 py-3 text-center">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function keepPlaying() {
                if (!forgotVideo) return;
                const playPromise = forgotVideo.play();
