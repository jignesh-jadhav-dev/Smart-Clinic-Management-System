    ...
    <div class="min-h-screen flex flex-col lg:flex-row relative z-10">
        ...
        <aside class="w-full lg:w-72 shrink-0 bg-emerald-900/90 text-white p-4 sm:p-6 shadow-2xl backdrop-blur-xl border-r border-white/10">
            ...
            <nav class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-1 gap-3">
                ...
                <a href="/doctor/leaves" class="sidebar-link flex items-center gap-3 bg-gradient-to-r from-green-500 to-emerald-500 px-4 py-3 rounded-2xl font-semibold shadow-lg">
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8">
            ...
            <div class="hero-card glass-card soft-shadow rounded-[30px] p-6 sm:p-8 mb-8 fade-up">
                <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                    <div>
                        <h1 class="text-3xl sm:text-4xl font-extrabold text-slate-800">Manage Leave Dates</h1>
                        <p class="text-slate-600 mt-3 text-base sm:text-lg">
                            Mark dates when you are unavailable. Patients will not be able to book appointments on those days.
                        </p>
                    ...
                    <div class="tip-box min-w-[260px]">
                        ...
                        <p class="text-slate-600 text-sm mt-2">Patients cannot book appointments on leave dates.</p>
                        <p class="text-slate-500 text-xs mt-1">Use this to keep your calendar accurate.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card soft-shadow rounded-[30px] p-5 sm:p-7 lg:p-8 mb-8 fade-up">
                ...
                <div class="mb-6">
                    <h2 class="text-2xl font-extrabold text-slate-800">Add Leave Date</h2>
                    <p class="text-slate-500 mt-1">Select a leave date and optionally mention the reason.</p>
                </div>
                ...
                <form action="/doctor/leaves" method="post" class="grid grid-cols-1 md:grid-cols-3 gap-5">

                    <div>
                        <label class="field-label">Leave Date</label>
                        <div class="input-shell">
                            <i class="fa-solid fa-calendar-day input-icon"></i>
                            <input type="date" name="leaveDate" required class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="input-shell textarea-wrap">
                            <i class="fa-solid fa-note-sticky input-icon textarea-icon"></i>
                            <input type="text"
                                   name="reason"
            ...
            <div class="glass-card soft-shadow rounded-[30px] p-5 sm:p-7 lg:p-8 fade-up">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                    <div>
                        <h2 class="text-2xl font-extrabold text-slate-800">My Leave Dates</h2>
                        <p class="text-slate-500 mt-1">Review your leave schedule and remove any date if needed.</p>
                    </div>

                    <span class="mini-chip bg-amber-100 text-amber-700">
                        <i class="fa-solid fa-layer-group"></i>
                        Total Leave Days: ${leaves.size()}
                    </span>
                </div>
                    ...
                    <c:choose>
                        <c:when test="${not empty leaves}">
                            <c:forEach var="leave" items="${leaves}">
                                <div class="leave-card bg-white/70 rounded-[24px] p-5 shadow-sm border border-white">
                                    <div class="flex items-start justify-between gap-3">
                                        <div>
                                            <p class="text-slate-800 font-bold text-lg">${leave.leaveDate}</p>
                                            <p class="text-slate-500 mt-1 text-sm">Leave date marked</p>
                                        </div>
                                    ...
                                    <div class="mt-5 flex items-center justify-between gap-3">
                                        ...
                                        <a href="/doctor/leave/delete/${leave.id}"
                                           onclick="return confirm('Are you sure you want to remove this leave date?')"
                        ...
                        <c:otherwise>
                            <div class="md:col-span-2 xl:col-span-3 bg-white/70 rounded-[24px] p-10 text-center border border-slate-200/60">
                                <div class="w-20 h-20 mx-auto rounded-full bg-red-100 text-red-700 flex items-center justify-center text-3xl shadow-sm mb-4">
                                    <i class="fa-solid fa-calendar-xmark"></i>
                                </div>
                                <h3 class="text-2xl font-bold text-slate-700">No Leave Dates Added</h3>
                                <p class="text-slate-500 mt-2">Add leave dates to block bookings for those days.</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
