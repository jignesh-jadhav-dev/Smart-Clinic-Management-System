...
<head>
    <meta charset="UTF-8">
    <title>Register - Smart Clinic Management</title>
    ...
    <style>
        ...
        @keyframes borderGlow {
            0%, 100% {
                box-shadow: 0 0 0 0 rgba(16,185,129,0.00);
            }
            50% {
        ...
        .auth-bg {
            background: linear-gradient(-45deg, #dcfce7, #dbeafe, #ede9fe, #fef3c7, #f0fdf4);
        ...
        .form-control:focus {
            border-color: #34d399;
            background: #ffffff;
            box-shadow: 0 0 0 4px rgba(52,211,153,0.18), 0 14px 30px rgba(16,185,129,0.12);
        }
                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="text-center mb-8 fade-up">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-[24px] bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center shadow-2xl pulse-glow">
                                <i class="fa-solid fa-user-plus text-white text-2xl sm:text-3xl"></i>
                            </div>

                            <h2 class="text-3xl sm:text-4xl font-black text-slate-800 mt-5">Create Account</h2>
                            <p class="text-slate-500 mt-3 text-base sm:text-lg">
                                Register as a patient to book appointments easily
                            </p>
                        </div>
                        ...
                        <form action="/register" method="post" class="space-y-5 fade-up">

                            <div>
                                <label class="block text-slate-700 mb-2 font-semibold">Full Name</label>
                            ...
                            <div>
                                <label class="block text-slate-700 mb-2 font-semibold">Phone</label>
                                <div class="input-shell">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function keepPlaying() {
                ...
                const playPromise = registerVideo.play();
